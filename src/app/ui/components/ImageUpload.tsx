        ...
        try {
            ...
            if (currentImageId) {
                ...
                try {
                    ...
                    const deleteResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/images/${currentImageId}`, {
                        method: 'DELETE',
                        headers: {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/images/upload/${menuItemId}`, {
                method: 'POST',
                body: formData,
            })
